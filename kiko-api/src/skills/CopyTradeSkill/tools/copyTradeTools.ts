...
export const CreateCopyTradeConfigTool: Tool = {
    ...
    handler: async (args, _context) => {
        return {
            summary: 'For security reasons, copy-trade configuration creation must be signed by the user in the Trade page. Please open Trade and confirm with wallet signature.',
            requires_user_signature: true,
            __client_action: {
                type: 'open_trade_page_for_signed_copytrade',
                data: {
                    suggestedTargetWallet: args.target_wallet,
                    suggestedBuyAmountUsd: args.buy_amount_usd
                }
            }
        };
    }
