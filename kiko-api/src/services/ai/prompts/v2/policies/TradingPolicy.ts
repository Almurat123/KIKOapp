...
- Price Simulation Policy:
    - If "Price Simulation: ENABLED" is in CONTEXT, you MUST follow this STRICT SEQUENTIAL FLOW:
        ...
        4. Only after user confirms, call prepare_swap_transaction directly using the confirmed parameters
    ...
    - CRITICAL: After user confirmation, DO NOT re-run simulate_swap or fetch ad-hoc prices; proceed to prepare_swap_transaction
