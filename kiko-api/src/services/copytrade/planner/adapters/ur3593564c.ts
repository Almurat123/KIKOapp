...
function buildReplayPlan(input: PlannerInput, commands: string, inputs: string[], sourceCalldata: string, sourceValue: bigint): ExecutionPlanV1 {
  ...
  return {
    ...
    trace: {
      ...
      adapterName: 'ur3593564c',
      adapterVersion: '1'
    }
  };
}

export const ur3593564cAdapter: SourceReplayAdapter = {
  name: 'ur3593564c',
  version: '1',
...
export function getUrReplaySpender(): string {
  return ethers.getAddress('0x000000000022D473030F116dDEE9F6B43aC78BA3').toLowerCase();
}
