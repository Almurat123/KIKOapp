/**
 * KiKo Swap Agent - Minimal Prompt
 * Principle: AI already understands DeFi, only provide project-specific rules and tools
 */
...
export const GROK_CORE_PROMPT = CORE_PROMPT;
export const DEEPSEEK_CORE_PROMPT = CORE_PROMPT;
