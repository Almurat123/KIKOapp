...
**Effective Date: April 19, 2026 | Version: v2.1**
...
- **Image Prompts and Reference Images**: Prompts, uploaded source images, edit instructions, and other image-generation inputs that you provide.
...
- **Generated Images and Moderation Metadata**: Generated image assets, revised prompts, moderation decisions, and sharing targets for any image-generation request.

### 1.3 Data We Do NOT Collect
- **IP Addresses**: The Service uses Cloudflare edge network for delivery and security before requests reach KIKO's servers. KIKO does not store any user IP addresses.
...
Generated images may remain private in your account history unless you explicitly share them to a public surface that requires a durable URL or embed.
...
| Image Prompts / Reference Images | Image generation, image editing, moderation, and safety filtering |
...
| Generated Images | History display, private storage, user-initiated sharing, and output review |
...
| Provider | Purpose |
|---|---|
| **OpenAI** | Image generation and image moderation for GPT image features |
| **xAI / Grok** | Image generation for Grok image features |
| **Cloudflare R2** | Private storage for uploaded and generated image assets |
...
| **Cloudflare** | Edge network, caching, and edge security |
...
For image-generation features, prompts, reference images, moderation data, and generated outputs may be transmitted to the applicable image provider and moderation service, and may be stored privately so the Service can display your image history and deliver sharing links when you choose to publish them.
